...
if __name__ == "__main__":
    ...
    t2m.load()
    #t2m = SurfaceObservations(basevar = 'tg', basedir = '/nobackup/users/straaten/ERA5/', name = 'tg-anom_1998-06-07_2019-10-31_7D-roll-mean_0.58-t2m-q075-mean') # Override normal E-OBS directory
    #t2m.load()
    #t2m.newvar = 'anom'
    ...
    modelclim.local_clim(tmin = '1998-06-07', tmax = '2018-08-31', timemethod = t2m.timemethod, spacemethod = t2m.spacemethod, mean = False, quant = 0.9, lead_time_dep = False, clusterarray = clusterarray, loadkwargs = loadkwargs, newvarkwargs = newvarkwargs, basedirkwargs = basedirkwargs)
