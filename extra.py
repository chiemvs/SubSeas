...
if __name__ == "__main__":
    ...
    e = EventClassification(obs = t2m, climatology = c)
    e.hotdays(inplace = True, windowsize = 4)

    t2m.construct_name(force = True)
    ...
    # Might need to call this a different type of climatology
